...
def p2tr_musig_option_3(logger=False):
    ...
    try:
        ...
        raise Exception("Invalid M and N")
    print("\n\n #######  \'P2TR multiple m-of-m TapScript Multisig\' Output Transaction Details  #######   \n\n")
    try:
        privkeys = list()
        pubkeys = list()
        ...
        print("MuSig aggregated pubkey: {}".format(musig_agg.get_bytes().hex()))
        ...
        print("\n\n #######  \'P2TR multiple m-of-m TapScripts Multisig\' Spending Transaction Details  #######   \n\n")
        # Create Spending Tx
