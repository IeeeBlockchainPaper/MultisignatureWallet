...
def p2wsh_over_p2sh(logger=False):
    ...
    print("\n\n #######  P2WSH Over P2SH Output Transaction Details  #######   \n\n")
    ...
    try:
        ...
        print(f"P2WSH Over P2SH Locking Script: {tx_information['vout'][0]['scriptPubKey']['asm']}")
        print(f"P2WSH Over P2SH locking script size: 22 bytes")
        logger.warning(f"P2WSH Over P2SH address: {address} ")
        # logger.warning(f"Size of the p2sh_address hash is {len(p2sh_address_hash)} bytes")
        logger.warning(f"P2WSH Over P2SH address size: {len(bytearray(address.encode()))} bytes")
        ...
        print("\n\n #######  P2WSH Over P2SH Input Spending Transaction Details  #######   \n\n")
        ...
        print("\P2WSH Over P2SH Unlocking Script: \n")
        for op in witness_elements:
            print(op.hex()) if isinstance(op, bytes) else print(op)
        print()
